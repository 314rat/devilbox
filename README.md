# 24.02.2024 добавлен 🖥️ Devilbox Manager

### 🌟 Что это такое?

Devilbox Manager - легковесный desktop-инструмент для управления Docker-окружением Devilbox прямо из системного трея Windows.

### ✨ Возможности

- 🔄 Быстрое переключение версий PHP, веб-сервера и MySQL
- 🐳 Управление Docker-контейнерами одним кликом
- 🌐 Автоматическое обнаружение и запуск веб-проектов
- 📂 Быстрый доступ к файлам конфигурации
- 🚀 Минимальный overhead для разработчика
